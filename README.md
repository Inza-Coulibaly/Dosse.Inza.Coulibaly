...
![Bannière Dosse Inza COULIBALY](https://raw.githubusercontent.com/Inza-Coulibaly/Dosse.Inza.Coulibaly/main/images/banniere.png)
...
|--------|-------------------------|
| **BI & Reporting** | Power BI (DAX, Power Query), Excel avancé (Power Pivot, VBA), Power Apps, Power Automate |
| **Data Science & Stats** | Python (pandas, numpy, scikit-learn), R, STATA, Modélisation statistique, Machine Learning |
| **Bases de données** | PostgreSQL, MongoDB, Neo4j, PL/pgSQL |
| **Collecte & nettoyage** | KoboToolbox, SQL, Excel |
| **Sécurité & conformité** | RGPD, Bonnes pratiques de sécurisation |

---

## 🚀 Projets phares (disponibles sur GitHub)

### 1️⃣ Analyse des ventes d'un réseau de magasins  
...
| Période | Poste / Mission | Entreprise |
|--------|-----------------|------------|
| 2025 | Stagiaire Business Intelligence & Reporting | ATLANTIC GROUP |
| 2024 | Stagiaire Analyse Crédit | AFG BANK |
| 2023 | Assistant Data Manager | BRAINLAND CONSULTING GROUP |
| 2022 | Stagiaire Analyse Statisticien | ADCVI (OIA-Légumes) |
...
Veille data · Football · Voyages

---

⭐️ *“Donner du sens aux données, avec rigueur et créativité.”*
